...
namespace FiguresSquare
{
    public class FigureCircle : FigureBase
    {
        ...
        {
            //Если часто происходит запрашивание доступа к площади фигуры и производительность важнее занимаемой памяти, 
            //то можно площадь можно не вычислять каждый раз, а сохранить в переменной
